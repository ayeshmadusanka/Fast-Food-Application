...
class _ProfileScreenState extends State<ProfileScreen> with TickerProviderStateMixin {
  final String username = "ayeshmadusanka";
  final String phoneNumber = "0772813834";
  ...
  void initState() {
    ...
    _animationController = AnimationController(
      duration: Duration(milliseconds: 700), // 1000ms duration
      vsync: this,
    );
                ...
                child: FadeTransition(
                  ...
                  child: GestureDetector(
                    ...
                    child: ListTile(
                      ...
                      title: Text(
                        "Orders",
                        style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600, color: Colors.orange.shade900),
                      ),
