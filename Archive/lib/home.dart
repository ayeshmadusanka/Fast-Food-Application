        ...
        if (index == 2) {
          ...
          Navigator.push(
            ...
            MaterialPageRoute(builder: (context) =>
                ProfileScreen()), // Replace with your ProfileScreen widget
          );
        } else if (index == 3) {
          // Navigate to Menu Screen
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => MenuPage()), // Replace with your MenuPage widget
          );
        }
        else if (index == 1) {
          // Navigate to Menu Screen
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => OffersPage()), // Replace with your MenuPage widget
          );
        }
      },
      items: const [
